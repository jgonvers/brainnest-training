...
def func1():
    ...
    lbl2 = Label(
        newWindow, text="type", width=10, bg="white", fg="black", font=(3)
    )
    lbl2.grid(row=2, column=1)
    lbl3 = Label(
        newWindow, text="amount", width=10, bg="grey", fg="black", font=(3)
    )
    ...
    lbl5 = Label(
        newWindow, text="datetime", width=10, bg="grey", fg="black", font=(3)
    )
    lbl5.grid(row=5, column=1)

    ent2 = Entry(newWindow, width=20, bg="white", fg="black", font=(3))
    ent2.grid(row=2, column=2)
    ent3 = Entry(newWindow, width=20, bg="grey", fg="black", font=(3))
    ent3.grid(row=3, column=2)
    ent4 = Entry(newWindow, width=20, fg="black", font=(3))
    ent4.grid(row=4, column=2)
    ent5 = Entry(newWindow, width=20, bg="grey", fg="black", font=(3))
...
def func4():
    ...
    lbl7 = Label(
        goalWindow, text="datetime", width=15, bg="white", fg="black", font=(3)
    )
    ...
    ent7 = Entry(goalWindow, width=15, bg="white", fg="black", font=(3))
    ent7.grid(row=2, column=2)
    ent8 = Entry(goalWindow, width=15, bg="grey", fg="black", font=(3))
